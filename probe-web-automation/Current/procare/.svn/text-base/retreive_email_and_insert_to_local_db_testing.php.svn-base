...
// Email Settings
$email_host = "imap.collaborationhost.net";
$email_port = "993";
$email_user = "pro_care@ineoquest.com";
$email_pass = "Passw0rd!";

// Connect to imap server
$mbox = imap_open ("{".$email_host.":".$email_port."/imap/ssl/novalidate-cert/notls/debug}INBOX", $email_user, $email_pass)
      or die("can't connect: " . imap_last_error());
//$mbox = imap_open ("{".$email_host.":".$email_port."/pop3/ssl/novalidate-cert}INBOX", $email_user, $email_pass)
//      or die("can't connect: " . imap_last_error());
