...
# Other Default Vars
my $probe = 'Columbia';                # Name of the ouput file
...
$line = 1;
$sheet = 3; # Sheet 3 is the HOTG SC tab
...
while( $ref->[$sheet]{'A'.$line} ne undef || $line < 10 ) {
	...
	if( $primaryFlowName ne "" &&
		...
		# Flowname with sheet prefix
		$primaryFlowName = 'COL-'.$primaryFlowName;
